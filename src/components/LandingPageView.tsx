  ...
  return (
    <div className="phx-landing" ref={pageRef}>
      ...
      <main id="conteudo">
        ...
        <section
          className="phx-section details-section"
          id="diferenciais"
        ...
        >
          <div className="phx-container">
            ...
            <div className="details-grid">
              <article className="detail-card detail-brand" data-reveal>
                <div className="detail-top">
                  <Palette size={24} />
                  <span>01</span>
                </div>
                <h3>Sua marca em primeiro plano.</h3>
                <p>
                  Nome, logotipo e uma composição clara. Uma peça personalizada
                  para fazer parte do seu ambiente.
                </p>
                <div className="brand-preview" aria-hidden="true">
                  ...
                  <span>Feita para ser sua.</span>
                </div>
              </article>
              <article className="detail-card detail-links" data-reveal>
                <div className="detail-top">
                  <ArrowUpRight size={24} />
                  <span>02</span>
                </div>
                <h3>Um toque. O destino que faz sentido.</h3>
                <p>
                  Escolha o canal que deseja aproximar do cliente. A
                  configuração é combinada com a Phoenix no pedido.
                </p>
                <div className="destination-list">
                  ...
                  <span>
                    <Globe2 size={17} />
                    Site ou cardápio digital
                    <ArrowUpRight size={14} />
                  </span>
                </div>
              </article>
              <article className="detail-card detail-size" data-reveal>
                <div className="detail-top">
                  <QrCode size={24} />
                  <span>03</span>
                </div>
                <h3>Feita para o balcão.</h3>
                <p>
                  Acrílico com suporte de mesa e duas formas de acesso. Compacta
                  para a equipe, visível para o cliente.
                </p>
